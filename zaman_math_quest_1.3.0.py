...
quiz = {
    "Algebra": {
        ...
        "Medium": [
            {"question": "Solve: 2x^2 = 18", "answer": "3"},
            {"question": "If x^2 = 49, what is x?", "answer": "7"},
            {"question": "Factor: x^2 - 25", "answer": "(x+5)(x-5)"}
        ],
        "Hard": [
            {"question": "Solve for x: x^2 - 4x + 3 = 0", "answer": "1 or 3"},
            {"question": "Simplify: (x^2 - 9)/(x + 3)", "answer": "x - 3"},
    ...
    "Addition": {
        ...
        "Medium": [
            ...
            {"question": "398 + 627 = ?", "answer": "1025"},
            {"question": "832 + 194 = ?", "answer": "1026"}
        ],
        "Hard": [
            {"question": "Add 3.145 + 7.82", "answer": "10.965"},
            {"question": "What is 1298 + 4827?", "answer": "6125"},
            {"question": "2345 + 6789 = ?", "answer": "9134"}
        ]
    },
    "Statistics": {
        "Easy": [
            {"question": "What is the mode of 2, 3, 3, 4?", "answer": "3"},
            {"question": "What is the mean of 2, 4, 6?", "answer": "4"},
            {"question": "What is the median of 5, 7, 9?", "answer": "7"}
        ],
        "Medium": [
            {"question": "Find the range: 3, 10, 6", "answer": "7"},
            {"question": "Mean of 2, 4, 6, 8, 10?", "answer": "6"},
            {"question": "What is the median of 1, 2, 3, 4, 5, 6?", "answer": "3.5"}
        ],
        "Hard": [
            {"question": "If mean is 5 and total is 25, how many numbers?", "answer": "5"},
            {"question": "What is the standard deviation of 2, 4, 4, 4, 5, 5, 7, 9?", "answer": "2"},
            {"question": "What is the interquartile range of 1–9?", "answer": "4"}
        ]
    }
}
...
image_path = r"C:\Users\21301.LYNFIELD\OneDrive - Lynfield College\Zaman Assessment 91906 and 91907\All versions + features\tools.gif"
